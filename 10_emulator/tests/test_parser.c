...
void test_parser_next_token_number_dec_pos2(void) {
    printf("\n*** test_parser_next_token_number_dec_pos2 ***\n");
...
void test_parser_next_token_number_hex_pos(void) {
    printf("\n*** test_parser_next_token_number_hex_pos ***\n");
