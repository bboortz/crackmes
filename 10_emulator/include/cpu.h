...
#define parser_cst_node(input_arr, i, err)                      cpu_6502_parser_cst_node(input_arr, i, err)
...
#define parser_cst_node(input_arr, i, err)                      cpu_8086_parser_cst_node(input_arr, i, err)
...
#define parser_cst_node(input_arr, i, err)                      cpu_386_parser_cst_node(input_arr, i, err)
...
#define parser_cst_node(input_arr, i, err)                      cpu_unknown_parser_cst_node(input_arr, i, err)
